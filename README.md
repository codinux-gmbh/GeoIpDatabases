...
## GeoIP REST API Client

Client for above's GeoIP REST API for a simple way to query geo information from GeoIP REST API in Kotlin.

### Gradle

```
implementation("net.codinux.geoip:geo-ip-rest-api-client:0.5.0")
```
